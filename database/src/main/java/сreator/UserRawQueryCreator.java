...
public interface UserRawQueryCreator {
    ...
    PreparedStatement getRawCreateSession(Connection connection, User user) throws SQLException;
    ...
    PreparedStatement getRawUpdateUser(Connection connection, User user, String oldEditableUsername) throws SQLException;
